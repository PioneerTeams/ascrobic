<template>
  <div class="card-group">
    <el-form :inline="true" :model="formInline" class="demo-form-inline" label-width="90px">
      ...
      <el-form-item v-if="show==false" label="SKU编码:">
        <el-input v-model="formInline.sku_code" placeholder="请输入" />
      </el-form-item>
      ...
      <el-form-item v-if="show" label="商品类型:">
      ...
      <el-form-item v-if="show" label="配送方式:">
...
import { manageList, basicMinxin } from '@/api/commodity'
