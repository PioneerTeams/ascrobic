        ...
        <div class="wrap">
            ...
            <div class="box">
                ...
                <div class="basic">
                    ...
                    <div class="list">
                        <span>详情图</span>
                        <span v-if="detail.detail_images.length==0">暂无</span>
                        <img v-else v-for="item in detail_images" :key="item.id" :src="item.images" alt="">
                    </div>
                    <div class="list">
                        <span>商品描述</span>
        ...
        methods: {
            getLookList(){
                tableSearch(this.$route.query).then(res=>{
                    ...
                    console.log(this.detail.detail_images.length)
